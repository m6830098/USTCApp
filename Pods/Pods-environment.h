...
// XHNewsFramework
#define COCOAPODS_POD_AVAILABLE_XHNewsFramework
#define COCOAPODS_VERSION_MAJOR_XHNewsFramework 0
#define COCOAPODS_VERSION_MINOR_XHNewsFramework 1
#define COCOAPODS_VERSION_PATCH_XHNewsFramework 0
