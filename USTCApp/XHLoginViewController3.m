...
{
    [super viewDidLoad];
	//UIColor *mainColor = [UIColor colorWithRed:28.0f/255 green:158.0f/255 blue:121.0f/255 alpha:1.0f];
    
    //UIColor* mainColor = [UIColor colorWithRed:28.0/255 green:158.0/255 blue:121.0/255 alpha:1.0f];
    self.view.frame = CGRectMake(30, 50, self.view.frame.size.width - 60, self.view.frame.size.height - 100);
    
    
    UIColor* darkColor = [UIColor colorWithRed:7.0/255 green:61.0/255 blue:48.0/255 alpha:0.5f];
    
    NSString* fontName = @"Avenir-Book";
    NSString* boldFontName = @"Avenir-Black";
    
    //self.navigationController.navigationBarHidden = NO;
//    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"profile"] style:UIBarButtonItemStylePlain target:self action:@selector(dopush)];
    
    self.view.backgroundColor = loginColor;

    
    _usernameField = [[UITextField alloc] initWithFrame:CGRectMake(25, 228, 160, 41)];
    ...
    _passwordField = [[UITextField alloc] initWithFrame:CGRectMake(25, 277, 160, 41)];
    ...
    _loginButton = [[UIButton alloc] initWithFrame:CGRectMake(25, 336, 160, 62)];
    ...
    _forgotButton = [[UIButton alloc] initWithFrame:CGRectMake(31, 382, 160, 62)];
    ...
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(31, 39, 160, 45)];
    _titleLabel.textAlignment = NSTextAlignmentCenter;
    _titleLabel.backgroundColor = [UIColor clearColor];
    _titleLabel.textColor =  [UIColor whiteColor];
    _titleLabel.font =  [UIFont fontWithName:boldFontName size:20.0f];
    _titleLabel.text = @"GOOD TO SEE YOU";
    
    _subTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(31, 82, 160, 25)];
